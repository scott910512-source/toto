...
### 공개해도 안전한 프록시 버전
사이트를 공개하면서 AI 추천도 쓰고 싶다면, API 키를 서버에 숨기는 **Cloudflare Workers
프록시**를 함께 배포하세요. 배포 방법은 [`worker/README.md`](worker/README.md)에 있습니다.
배포 후 `config.js`에 Worker 주소를 넣으면, 🤖 AI 추천이 키 입력 없이 동작합니다.
